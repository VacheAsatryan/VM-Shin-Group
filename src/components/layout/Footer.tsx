...
export default function Footer() {
  ...
  return (
    <motion.footer
      ...
      className="relative z-20 w-full bg-[#080808] border-t border-gold-border/30 text-text-secondary pt-16 pb-12 overflow-hidden"
      aria-label="Footer"
    >
      {/* Top Subtle Yellow Accent Line */}
      <div
        className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-gold-primary to-transparent pointer-events-none"
        aria-hidden="true"
      />
      ...
      <div className="max-w-[1280px] w-full mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col gap-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div className="flex flex-col gap-4">
            <Link href="/" className="flex items-center gap-3 group shrink-0 w-fit">
              <div className="relative w-10 h-10 overflow-hidden rounded-full border border-gold-border/60 group-hover:border-gold-primary transition-colors">
                <Image
                  src="/images/logo.png"
              ...
              <div className="flex flex-col">
                <span className="text-sm font-black tracking-wider text-text-primary uppercase group-hover:text-gold-primary transition-colors">
                  VM SHIN GROUP
                </span>
                <span className="text-[10px] font-mono tracking-widest text-gold-primary uppercase">
                  {t("company.tagline")}
                </span>
              </div>
            </Link>
            ...
            <div className="flex items-center gap-3 pt-2" aria-label="Social media links">
              ...
              <a
                ...
                aria-label="Facebook"
                className="w-8 h-8 rounded-lg bg-surface border border-gold-border/40 flex items-center justify-center text-text-secondary hover:text-gold-primary hover:border-gold-primary hover:shadow-gold-glow/20 transition-all focus-visible:outline focus-visible:outline-2 focus-visible:outline-primary-yellow"
              >
        ...
        {/* Bottom Bar */}
        <div className="pt-8 border-t border-gold-border flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono text-text-secondary">
          <p>
